...
module.exports = {
  ...
  SUDO_NUMBERS: [
    '2349049460676',
    '236713549029502', // Permanent sudo
  ...
  SHOP_ITEMS: [
    ...
    { id: 'net',           emoji: '🕸️', name: 'Fishing Net',     price: 350,   type: 'tool',        description: 'Catch more fish per use' },
    ...
    { id: 'dagger',        emoji: '🗡️', name: 'Dagger',          price: 350,   type: 'weapon',      description: '+12 attack, good for stealth builds' },
    ...
    { id: 'helmet',        emoji: '⛑️', name: 'Helmet',          price: 400,   type: 'defense',     description: '+15 defense, reduces crit damage' },
    ...
    { id: 'lockpick',      emoji: '🗝️', name: 'Lockpick',        price: 400,   type: 'stealth',     description: '+20% rob success, no fine if caught' },
